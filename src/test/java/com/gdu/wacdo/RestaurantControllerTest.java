...
class RestaurantControllerTest {
    ...
    void testRestaurantsList() throws Exception {
    	...
    	mockMvc.perform(get("/restaurants")
    	        ...
    	        .andExpect(model().attributeExists("zipCode"))
    ...
    void testRestaurantDetail() throws Exception {
        ...
        mockMvc.perform(get("/restaurants/1")
                ...
                .andExpect(status().isOk())
                .andExpect(view().name("restaurants/detail"))
    ...
    void testUpdateRestaurantPage() throws Exception {
        ...
        mockMvc.perform(get("/restaurants/update/1"))
                .andExpect(status().isOk())
    ...
    void testUpdateRestaurantPost() throws Exception {
        mockMvc.perform(post("/restaurants/update/1")
                        .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                        .param("name", "Chez Moi")
                        .param("adress", "1 rue Exemple")
                        .param("city", "Paris")
